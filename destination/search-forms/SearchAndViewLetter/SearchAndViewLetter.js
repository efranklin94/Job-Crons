...
SearchTemplates.SearchAndViewLetters = function(searchParameters) {
	if (!(this instanceof SearchTemplates.SearchAndViewLetters))
        return new SearchTemplates.SearchAndViewLetters(searchParameters);

    BaseSearchTemplate.call(this, searchParameters);
    var _that = this;

    this.getTemplateURL = function() {
        return "js/plugins/PAT/search-forms/SearchAndViewLetter/SearchAndViewLetter.html";
    }
    ...
    this.defineController = function() {
        ...
        angular.module('myApp').register.controller(controllerName, function ($scope, $rootScope, $state, $http, $q, notificationService) {
            ...
            $scope.toolbarTitle = AssetManager.getMessage(config.locale.locale, "SEARCH_AND_VIEW_LETTER");
            setTimeout(function() {
