...
SearchTemplates.ReceivedLetters = function(searchParameters) {
	if (!(this instanceof SearchTemplates.ReceivedLetters))
        return new SearchTemplates.ReceivedLetters(searchParameters);

    BaseSearchTemplate.call(this, searchParameters);
    var _that = this;

    this.getTemplateURL = function() {
        return "js/plugins/PAT/search-forms/ReceivedLettersSearch/ReceivedLettersSearch.html";
    }
    ...
    this.defineController = function() {
        ...
        angular.module('myApp').register.controller(controllerName, function ($scope, $rootScope, $state, $http, $q, notificationService) {
            ...
            $scope.toolbarTitle = "نامه های دریافتی";
            setTimeout(function() {
