...
SearchTemplates.SentLetters = function(searchParameters) {
	if (!(this instanceof SearchTemplates.SentLetters))
        return new SearchTemplates.SentLetters(searchParameters);

    BaseSearchTemplate.call(this, searchParameters);
    var _that = this;

    this.getTemplateURL = function() {
        return "js/plugins/PAT/search-forms/SentLettersSearch/SentLettersSearch.html";
    }
    ...
    this.defineController = function() {
        ...
        angular.module('myApp').register.controller(controllerName, function ($scope, $rootScope, $state, $http, $q, notificationService) {
            ...
            $scope.toolbarTitle = "نامه های ارسالی";
            setTimeout(function() {
