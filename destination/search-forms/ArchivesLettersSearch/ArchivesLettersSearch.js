...
SearchTemplates.ArchivesLetters = function(searchParameters) {
	if (!(this instanceof SearchTemplates.ArchivesLetters))
        return new SearchTemplates.ArchivesLetters(searchParameters);

    BaseSearchTemplate.call(this, searchParameters);
    var _that = this;

    this.getTemplateURL = function() {
        return "js/plugins/PAT/search-forms/ArchivesLettersSearch/ArchivesLettersSearch.html";
    }
    ...
    this.defineController = function() {
        ...
        angular.module('myApp').register.controller(controllerName, function ($scope, $rootScope, $state, $http, $q, notificationService) {
            ...
            $scope.toolbarTitle = "آرشیو نامه ها";
            setTimeout(function() {
